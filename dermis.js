...
})( window );// Generated by CoffeeScript 1.3.3
(function() {
  ...
  define("dermis/EventEmitter", function() {
    var EventEmitter;
  ...
  define("dermis/View", ["dermis/EventEmitter"], function(EventEmitter) {
    var View;
    View = (function(_super) {
      ...
      View.prototype.render = function(obj) {
        var src;
        this.emit('prerender', obj);
        src = this._render(obj);
        this.emit('postrender', obj, src);
        return this;
      };

      View.prototype.hide = function(selector) {
        var _this = this;
        this.once('rendered', function(select) {
          if (select == null) {
            select = selector;
          }
          $(select).hide();
          return _this.emit('hidden', select);
        });
        return this;
      };

      View.prototype.prepend = function(selector) {
        var _this = this;
        this.once('postrender', function(obj, src) {
          $(selector).prepend(src);
          return _this.emit('rendered', selector, obj, src);
        });
        return this;
      };

      View.prototype.append = function(selector) {
        var _this = this;
        this.once('postrender', function(obj, src) {
          $(selector).append(src);
          return _this.emit('rendered', selector, obj, src);
      ...
      View.prototype.html = function(selector) {
        var _this = this;
        this.once('postrender', function(obj, src) {
          $(selector).html(src);
          return _this.emit('rendered', selector, obj, src);
      ...
      View.prototype.target = View.prototype.html;

      View.prototype.replace = View.prototype.html;

      View.prototype.fadeIn = function(selector, easing) {
        var _this = this;
        if (easing == null) {
          easing = "slow";
        }
        ...
        this.once('rendered', function(select) {
          ...
          return $(select).fadeIn(easing, function() {
            return _this.emit('fadeIn', select);
          });
        });
        return this;
      };
